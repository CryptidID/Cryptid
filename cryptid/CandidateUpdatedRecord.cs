...
namespace cryptid {
    ...
    class CandidateUpdatedRecord {
        ...
        public static CandidateUpdatedRecord Unpack(byte[] packed, RSAParameters pubKey) {
            ...
            return new CandidateUpdatedRecord(Arrays.CopyOfRange(packed, 0, ChainIdLength), Arrays.CopyOfRange(packed, ChainIdLength, ChainIdLength * 2));
        }
    }
}
