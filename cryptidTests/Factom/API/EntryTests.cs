...
namespace Cryptid.Factom.API.Tests {
    ...
    public class EntryTests {
        ...
        public void GetChainTest() {
            ...
            Entry api = new Entry();
            byte[] val = Strings.DecodeHexIntoBytes("475fbcef5e3a4e1621ed9a6fda5840c1d654715e55a8f5e514af0fb879ce0aec");

            ChainHeadData chainHead = api.GetChainHead(val);
